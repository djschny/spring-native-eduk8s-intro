...
ESP_PREVIEW_CLUSTER   = kube-stg-acf6c1f
version               = latest
...
.PHONY: build kind-start kind-stop educates-deploy educates-refresh release deploy get-reporeg get-name get-esp-preview-cluster
